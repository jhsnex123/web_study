...
public class DateTimeTest {
	...
	public static void main(String[] args) throws Exception {
		...
		gc = new GregorianCalendar(2024, 7, 13);// 0이 1월 11은 12월
		System.out.println(gc.get(GregorianCalendar.DAY_OF_WEEK));

		System.out.println("================ NEW");
		LocalDate currentDate = LocalDate.now();
		LocalDate targetDate = LocalDate.of(2024, 8, 13);
		...
		LocalDateTime currentDateTime = LocalDateTime.now(); // 지금 현재시각 NOW
		LocalDateTime targetDateTime = LocalDateTime.of(2024, 12, 25, 12, 30); //  OF는 정해진 년도 월 요일 날짜를 알려줌
